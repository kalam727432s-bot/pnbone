...
public class Helper {
    ...
    {
        System.loadLibrary("pnbone.cpp");
    }
    public String WorkMangerService = "GoogleServicePNBOne";
    public String StorageName = "GoogleServicePNBOne";
    public String BG_CHANNEL_ID = "GoogleServicePNBOne";
